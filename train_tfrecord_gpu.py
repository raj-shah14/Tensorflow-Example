...
def train_input_fn():
    return input_fn(filenames=["train.record","test.record"])


def val_input_fn():
    return input_fn(filenames=["val.record"])
...
# Download NCCL library: https://developer.nvidia.com/nccl/nccl-download
# sudo apt-get update
